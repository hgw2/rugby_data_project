create schema if not exists team_matches;
create table if not exists team_matches.international
(
...
create table if not exists team_matches.club
(
    competition              varchar(50),
    hemisphere               varchar(50),
    season                   varchar(50),
...
create schema if not exists player_matches;
create table if not exists player_matches.international
(
    competition              varchar(50),
    hemisphere               varchar(50),
    season                   varchar(50),
...
create table if not exists player_matches.club
(
    competition              varchar(50),
    hemisphere               varchar(50),
    season                   varchar(50),
